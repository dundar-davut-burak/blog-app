...
export default function AdminNewPostForm() {
    return (
        <form className="border rounded-xl shadow-sm" method="POST">
            ...
            <div className="flex flex-col px-6 py-4">
                ...
                <div className='my-3'>
                    <label htmlFor="content" className="block text-sm mb-2">Açıklama (description for SEO)</label>
                    <textarea id="content" name="content" rows={3} className="py-3 px-4 block w-full ring-1 ring-gray-300 rounded-lg text-sm outline-none focus:ring-indigo-500 focus:ring-2" placeholder="Lütfen açıklama giriniz. Max. 300 kelime" maxLength={300} required></textarea>
                </div>
                <div className='my-3'>
                ...
                <div className="flex flex-wrap -m-2 my-3">
                    <div className="p-2 w-1/2">
                        <div className="relative">
                            <label htmlFor="website-admin" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Yazar</label>
                            <div className="flex">
                                ...
                                <input type="text" id="website-admin" className="rounded-none rounded-e-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5" placeholder="Bilgehan Kocabıyık" disabled />
                            </div>
                        </div>
                    </div>
                    <div className="p-2 w-1/2">
